...
public class HomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        usernameLabel.setText(GymConnect.loggedUser.getUsername());
        userImage.setImage(new Image("https://avatars.dicebear.com/api/bottts/" + GymConnect.loggedUser.getUsername() + ".png"));
    }
