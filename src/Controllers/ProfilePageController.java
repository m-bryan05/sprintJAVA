...
public class ProfilePageController implements Initializable {
    ...
    public void setInfos() {
        this.username.setText(GymConnect.loggedUser.getUsername());
        this.userImage.setImage(new Image("https://avatars.dicebear.com/api/bottts/" + GymConnect.loggedUser.getUsername() + ".png"));
        this.coins.setText(Integer.toString(GymConnect.loggedUser.getCoins()));
        this.name.setText(GymConnect.loggedUser.getName());
        this.secondName.setText(GymConnect.loggedUser.getSecondName());
        this.verified.setVisible(GymConnect.loggedUser.getIsVerified() == 1);
    }
